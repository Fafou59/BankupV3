<div id="beneficiaires" class="item">
    <h1 style="font-variant: small-caps; text-transform: lowercase;">bénéficiaires de <?php echo($client['prenom_Client'].' '.$client['nom_Client']); ?></h1>
                    ...
                    <div class="ajout_Beneficiaire" style="padding-bottom:70px;">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td><input type="text" class="info_Requise" name="libelle_Beneficiaire" id="libelle_Beneficiaire" size="30" minlength="2" maxlength="30" placeholder="Entrez le libellé du bénéficiaire" required /></td>
                            </tr>
                            <tr>   
                                <td><label for="iban">iban</label> :</td>
                                <td><input type="text" class="info_Requise" name="iban" id="iban" size="27" minlength="27" maxlength="27" placeholder="Entrez l'IBAN du bénéficiaire" required /></td>   
                            </tr>
                        </table>
                        <div class="bouton_Form">
                            <button type="submit" class="bouton_Ouvrir" style="float:right;"> <img src="images/add-plus-button.png" style="width:25px; margin-right:20px;"> Ajouter</button>
                        </div>
                    </div>
                </form>
            </div>
